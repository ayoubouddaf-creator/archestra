 ...
 */
export const getWhatsAppQr = <ThrowOnError extends boolean = false>(options?: Options<GetWhatsAppQrData, ThrowOnError>) => (options?.client ?? client).get<GetWhatsAppQrResponses, GetWhatsAppQrErrors, ThrowOnError>({ url: '/api/chatops/whatsapp/qr', ...options });
 ...
 * `agentTrigger:update`: Modify agent trigger configurations
 */
export const deleteWhatsAppSession = <ThrowOnError extends boolean = false>(options?: Options<DeleteWhatsAppSessionData, ThrowOnError>) => (options?.client ?? client).delete<DeleteWhatsAppSessionResponses, DeleteWhatsAppSessionErrors, ThrowOnError>({ url: '/api/chatops/whatsapp/session', ...options });
